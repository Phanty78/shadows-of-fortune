          ...
          <main className="container mx-auto px-4 py-8">
            ...
            <div className="prose prose-invert max-w-none">
              ...
              <p>
                ...
                is recorded on public blockchain networks, which may include:
              </p>
              <ul className="list-disc pl-6 mb-4">
                <li>
                  Public Wallet Address: When you connect your digital wallet to
                  our game
                </li>
                <li>
              ...
              <p className="text-gray-300 italic">
                ...
                operated by third parties, and we do not control the storage or
                security of data stored on the blockchain.
              </p>
              ...
              <ul className="list-disc pl-6 mb-4">
                <li>
                  ...
                  functions correctly and providing you with requested services
                </li>
                <li>
              ...
              <p>
                ...
                networks. Information about these transactions may be accessible
                to anyone due to the transparent nature of the blockchain. This
                may include:
              </p>
              <ul className="list-disc pl-6 mb-4">
              ...
              <p>
                Our game is not intended for individuals under the age of 13 (or
                ...
                child under the applicable age, we will take steps to delete
              ...
              <p>
                ...
                services, including blockchain networks and digital wallets. We
