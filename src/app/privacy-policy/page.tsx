        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-lg mb-6">
              ...
              blockchain-based game and related services involving non-fungible
              tokens (NFTs). Please read this policy carefully.
            </p>
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                ...
                legal processes, or protect the rights and safety of our users
                and others
              </li>
              <li>
            ...
            <p>
              ...
              child under the applicable age, we will take steps to delete such
            ...
            <p>
              ...
              at the bottom. Your continued use of the game after any changes
