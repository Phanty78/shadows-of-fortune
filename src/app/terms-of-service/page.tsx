        ...
        <main className="container mx-auto px-4 py-8">
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-lg mb-6">
              ...
              (NFTs), you agree to be bound by these Terms of Service. Please
              read them carefully.
            </p>
            ...
            <p>
              ...
              obtained from Shadows of Fortune without our prior written
              permission.
            </p>
            ...
            <p>
              ...
              create a user account and connect a compatible digital wallet. You
              are responsible for maintaining the confidentiality of your
              account and wallet credentials. You agree to accept responsibility
              for all activities that occur under your account and wallet.
            </p>
            ...
            <ul className="list-disc list-inside">
              ...
              <li>
                ...
                subject to malfunctions, bugs, and hacking, which could result
                in loss of NFTs or digital assets.
              </li>
            </ul>
            <p>
            ...
            <p>
              Akanbe Studio reserves the right to modify these Terms of Service
              at any time. We will notify users of any changes by posting the
              new Terms of Service on this page. Your continued use of Shadows
              of Fortune after any such changes constitutes your acceptance of
            ...
            <p>
              ...
              game or its features. In no event shall Akanbe Studio be liable
              for any damages arising from the use or inability to use Shadows
              of Fortune or NFTs.
            </p>
